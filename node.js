...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'abtobsuites@gmail.com',      // <-- replace with your Gmail address
    pass: 'ehff jkcp rjel jxdc'          // <-- replace with your Gmail App Password
  }
});
...
app.post('/api/book', async (req, res) => {
  ...
  try {
    await transporter.sendMail({
      from: 'abtobsuites@gmail.com',
      to: email,
      subject: 'Bank Transfer Instructions - Abtob Hotel',
      text: message
    });
