...
app.post("/api/book", async (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "abtobsuites@gmail.com", // Replace with your actual email
      pass: "ehff jkcp rjel jxdc", // Use an App Password if using Gmail
    },
  });

  const mailOptions = {
    from: email,
    to: "abtobsuites@gmail.com", // Hotel's receiving address
